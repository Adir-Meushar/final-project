    ...
    return (
        <div className="about-container">
            ...
            <div className="about-content">
                <p>
                    Welcome to [Your E-commerce Site Name]!
                    At [Your E-commerce Site Name], we understand the importance of fresh, quality groceries in every household. That's why we've curated a selection of the finest basic groceries, focusing on essentials like vegetables, fruits, bakery items, dairy, and eggs, to meet your everyday needs.
            ...
            <ul className="about-list">
                ...
                <li>Whether you're stocking up on essentials, planning your weekly meals, or seeking inspiration for your next culinary adventure, [Your E-commerce Site Name] is here to make grocery shopping a breeze.</li>
            </ul>
            ...
            <p className="about-signature">[Your Name/Your Team's Name]<br />Founder, [Your E-commerce Site Name]</p>
        </div>
    );
}

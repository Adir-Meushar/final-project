...
//             const { img, nutritionalValue, ...rest } = currentProduct;
//             const { url: imgUrl, alt: imgAlt } = img || {};
//             setFormData({ ...rest, imgUrl, imgAlt, ...nutritionalValue });
//         } else {
//             setFormData({});
//         }
//     }, [currentProduct]);
...
//                                             value={formData[item.name]} // Access directly from formData
//                                             name={item.name}
